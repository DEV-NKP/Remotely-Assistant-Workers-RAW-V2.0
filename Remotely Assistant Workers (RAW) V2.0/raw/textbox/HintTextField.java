package raw.textbox;
 ...
 public Font lostFont = new Font("Tahoma", Font.ITALIC, 11);  
   ...
   public HintTextField(final String hint,Color cbordera,Color cborderb,Color cborderc,Color cborderd,Color cbordera1,Color cborderb1,Color cborderc1,Color cborderd1)//bg color active-bg color inactive-fg color-msg color-border color(4)-in border (4)
   {  
