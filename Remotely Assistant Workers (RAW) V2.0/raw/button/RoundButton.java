...
public class RoundButton extends RBRoundedCornerButton {
  public RoundButton() {
    super();
  }
 ...
 class RBRoundedCornerButton extends JButton {
  ...
  public RBRoundedCornerButton() {
    super();
  }

  public RBRoundedCornerButton(Icon icon) {
    super(icon);
  }

  public RBRoundedCornerButton(String text) {
    super(text);
  }

  public RBRoundedCornerButton(Action a) {
    super(a);
    // setAction(a);
  }

  public RBRoundedCornerButton(String text, Icon icon) {
    super(text, icon);
    // setModel(new DefaultButtonModel());
    // init(text, icon);
