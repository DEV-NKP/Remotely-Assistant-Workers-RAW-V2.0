...
public class RoundHoverButton extends RHBRoundedCornerHoverButton {
  public RoundHoverButton() {
    super();
  }

  public RoundHoverButton(Icon icon) {
    super(icon);
  }

  public RoundHoverButton(String text) {
    super(text);
  }

  public RoundHoverButton(Action a) {
    super(a);
    // setAction(a);
  }

  public RoundHoverButton(String text, Icon icon) {
    super(text, icon);
  ...
  @Override public void initShape() {
 ...
 class RHBRoundedCornerHoverButton extends RHBRCHHoverButton {
  ...
  public RHBRoundedCornerHoverButton() {
    super();
  }

  public RHBRoundedCornerHoverButton(Icon icon) {
    super(icon);
  }

  public RHBRoundedCornerHoverButton(String text) {
    super(text);
  }

  public RHBRoundedCornerHoverButton(Action a) {
    super(a);
    // setAction(a);
  }

  public RHBRoundedCornerHoverButton(String text, Icon icon) {
    super(text, icon);
    // setModel(new DefaultButtonModel());
    // init(text, icon);
 ...
 class RHBRCHHoverButton extends JButton
{
 public float alpha = 0.5f;

  public RHBRCHHoverButton() {
    super();
  }

  public RHBRCHHoverButton(Icon icon) {
    super(icon);
  }



  public RHBRCHHoverButton(Action a) {
    super(a);
    // setAction(a);
  }


  public RHBRCHHoverButton(String text)
  {
    super(text);
    setFocusPainted(false);
    ...
    public RHBRCHHoverButton(String text, Icon icon) {
    super(text, icon);
    // setModel(new DefaultButtonModel());
    // init(text, icon);
    // setContentAreaFilled(false);
 ...
 public RHBRCHHoverButton(String text,ImageIcon I)
  {
   super(text,I);
    setFocusPainted(false);
    setBorderPainted(false);
