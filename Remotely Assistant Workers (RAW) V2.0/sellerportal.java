...
/////////////////////////////cursor///////////////////////////////////
	...
	public sellerportal()
	{
		...
		public sellerportal(JFrame frame, String email, String pass)
	{
		...
		public sellerportal( String email, String pass)
	{
		this.USER_EMAIL=email;
		this.USER_PASSWORD=pass;
...
mainframe.getContentPane().add(sellerportalpage(mainframe), BorderLayout.CENTER);
...
public JLayeredPane sellerportalpage(JFrame frame)
{
...
try{		
		...
		try{
		String searchquery="SELECT * FROM `seller_signup_user_details` WHERE BINARY EMAIL  ='"+ USER_EMAIL+"'  AND BINARY PASSWORD='"+  USER_PASSWORD+"'";
...
this.STATUS_MESSAGE=result.getString("STATUS_MESSAGE");
			...
			try{
		String searchquery="SELECT * FROM `seller_signup_personal_details` WHERE BINARY EMAIL  ='"+ USER_EMAIL+"';";
...
this.COUNTRY=result.getString("COUNTRY");
			...
			try{
		String searchquery="SELECT * FROM `seller_signup_account_details` WHERE BINARY EMAIL  ='"+ USER_EMAIL+"';";
...
try{
		String searchquery="SELECT * FROM `seller_signup_basic_details` WHERE BINARY EMAIL  ='"+ USER_EMAIL+"';";
...
this.LAST_NAME=result.getString("LAST_NAME");
	...
	try{
		String searchquery="SELECT * FROM `seller_total_rating` WHERE BINARY EMAIL  ='"+ USER_EMAIL+"';";
...
////////////////////////////////////////   TRANSPARENT MAIN PANEL   /////////////////////////////////
  ...
  mainpanel1.setMinimumSize(new Dimension(400, 300));
  mainpanel1.setMaximumSize(new Dimension(1500, 800));
...
catch(Exception e1)
{
	...
	profilepicpan.setMaximumSize(new Dimension(250,170));
	...
	namepan.setBorder(new EmptyBorder(1,1,1,1));
	namepan.setMinimumSize(new Dimension(200,40));
	namepan.setPreferredSize(new Dimension(200,40));
	namepan.setMaximumSize(new Dimension(250,50));
	...
	postpan.setMinimumSize(new Dimension(200,30));
	postpan.setPreferredSize(new Dimension(200,30));
	postpan.setMaximumSize(new Dimension(250,40));
	...
	biopan.setBorder(new EmptyBorder(1,1,1,1));
	...
	logoutbutton.setForeground(new Color(27,27,27));
...
catch(Exception e1)
{
	System.out.println(e1);
			...
			loginmenu lm11 = new loginmenu(mainframe);
			mainframe.setJMenuBar(lm11.loginmenubar(mainframe));
			//mainframe.getContentPane().add(lm.loginmenupage(mainframe));
			mainframe.setContentPane(lm11.loginmenupage(mainframe));
			mainframe.setVisible(true);
		}		
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	JPanel sellerlabelpanel = new JPanel();
	sellerlabelpanel.setBackground(new Color(0, 0, 0));//new Color(75, 162, 233)
	sellerlabelpanel.setLayout(new BoxLayout(sellerlabelpanel, BoxLayout.X_AXIS));
	sellerlabelpanel.setBorder(new EmptyBorder(10,10,10,10));
	sellerlabelpanel.setAlignmentY(Component.TOP_ALIGNMENT);
	sellerlabelpanel.setAlignmentX(Component.CENTER_ALIGNMENT);

    JLabel sellerlabel1 = new JLabel("Seller Options");
	sellerlabel1.setFont(new Font("Arial",Font.BOLD,20));
	sellerlabel1.setForeground(Color.decode("#00cc99"));
	sellerlabel1.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	sellerlabel1.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	sellerlabel1.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	sellerlabel1.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	sellerlabel1.setAlignmentX(Component.CENTER_ALIGNMENT);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	JLabel rejectionlabel1 = new JLabel("Rejected works");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	ImageIcon imgmlogin1 = new ImageIcon("Resources/Images/Portal/s1.png"); //220*200
	...
	ImageIcon imgmlogin2 = new ImageIcon("Resources/Images/Portal/s2.png"); //220*200
JButton buttons2 = new JButton("",imgmlogin2);
	...
	ImageIcon imgmlogin3 = new ImageIcon("Resources/Images/Portal/s3.png"); //220*200
	...
	ImageIcon imgmlogin4 = new ImageIcon("Resources/Images/Portal/s4.png"); //220*200
	...
	ImageIcon imgmlogin5 = new ImageIcon("Resources/Images/Portal/s5.png"); //220*200
	...
	ImageIcon imgmlogin6 = new ImageIcon("Resources/Images/Portal/s6.png"); //220*200
	...
	ImageIcon imgmlogin7 = new ImageIcon("Resources/Images/Portal/s7.png"); //220*200
	...
	ImageIcon imgmlogin8 = new ImageIcon("Resources/Images/Portal/s8.png"); //220*200
	...
	ImageIcon imgmlogin9 = new ImageIcon("Resources/Images/Portal/s9.png"); //220*200
	...
	ImageIcon imgmlogin10 = new ImageIcon("Resources/Images/Portal/s10.png"); //220*200
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	ImageIcon imgmlogin11 = new ImageIcon("Resources/Images/Portal/s11.png"); //220*200
	...
	ImageIcon imgmlogin12 = new ImageIcon("Resources/Images/Portal/s12.png"); //220*200
	...
	ImageIcon imgmlogin13 = new ImageIcon("Resources/Images/Portal/s13.png"); //220*200
	...
	ImageIcon imgmlogin14 = new ImageIcon("Resources/Images/Portal/s14.png"); //220*200
	...
	ImageIcon imgmlogin15 = new ImageIcon("Resources/Images/Portal/s15.png"); //220*200
...
sellerlabelpanel.add(sellerlabel1);
...
contentpan.add(sellerlabelpanel);
