...
////// COMPANY DETAILS //////
	...
	boolean coty=false;
	boolean desig=false;
	boolean wamoun=false;
	boolean coadd=false;
	boolean whbuy=false;
	
	String SUBCOMPANY_NAME="";
	String SUBCOMPANY_TYPE="";
	String SUBCOMPANY_DESIGNATION="";
	String SUBWORKERS_AMOUNT="";
	String SUBCOMPANY_ADDRESS="";
	String SUBBUYER_REASON="";
...
/////////////////////////////cursor///////////////////////////////////
	...
	public buyersignup()
	{
		...
		public buyersignup(JFrame frame)
	{
	    screensize = Toolkit.getDefaultToolkit().getScreenSize();
        x = (int) ((screensize.getWidth() - ((screensize.width/2)+320)) / 2);
        y = (int) ((screensize.getHeight() - ((screensize.height/2)+220)) / 2);
...
public JPanel buyersignpage(JFrame frame)
{
...
screensize = Toolkit.getDefaultToolkit().getScreenSize();
	...
	mbutton3.addMouseListener(new MouseAdapter(){
	 ...
	 mbutton4=new RoundedCornerHoverButton("  Company Details  ");
	...
	contentpan.setMaximumSize(new Dimension((screensize.width-menupanel.getWidth()),screensize.height));
		...
		contentpan.removeAll();
		contentpan.add(companydetails(contentpan));
		contentpan.revalidate();
...
public JPanel signinfo(JPanel p)
{
	...
	JLabel buyersignlabel3 = new JLabel("<html>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Looking for an assistant? That's why RAW is here. <br>&nbsp;&nbsp;&nbsp;All you need to do is SignUp and LogIn to get the assistant.</html>");
...
String emailsearch="SELECT * FROM `buyer_signup_basic_details` WHERE EMAIL='"+ emailtxtfield.getText()+"'";
...
String mobilesearch="SELECT * FROM `buyer_signup_basic_details` WHERE MOBILE_NUMBER='"+ phonetxtfield.getText()+"'";
...
String nidsearch="SELECT * FROM `buyer_signup_personal_details` WHERE NID_NUMBER='"+ nidtxtfield.getText()+"'";
...
String ppnsearch="SELECT * FROM `buyer_signup_personal_details` WHERE PASSPORT_NUMBER='"+ passporttxtfield.getText()+"'";
...
public JPanel userdetails(JPanel p)
{
	...
	usdfirstpanel.setBorder(new EmptyBorder(0,0,0,0));
...
newlabel4.setText("<html> </html>");
	...
	try{		
		...
		Connection connection=(Connection) DriverManager.getConnection(url,username,password);//url,uname,pass
		Statement statement=connection.createStatement();
		String nidsearch="SELECT * FROM `buyer_signup_user_details` WHERE USER_NAME='"+ usernametxtfield.getText()+"'";
ResultSet result1=statement.executeQuery(nidsearch);	
		if(result1.next())
		{
...
usdfirstpanel.add(Box.createRigidArea(new Dimension(10, 0)));
...
public JPanel companydetails(JPanel p)
{
	
	screensize = Toolkit.getDefaultToolkit().getScreenSize();
	
	JPanel companypan = new JPanel();
	companypan.setBackground(new Color(44, 47, 51));
	companypan.setLayout(new BoxLayout(companypan, BoxLayout.Y_AXIS));
	companypan.setAlignmentX(Component.CENTER_ALIGNMENT);
	companypan.setMinimumSize(new Dimension(p.getWidth(), p.getHeight()));
	companypan.setPreferredSize(new Dimension(p.getWidth(), p.getHeight()));
	companypan.setMaximumSize(new Dimension(screensize.width, screensize.height));
	
    JPanel companyfirstpanel = new JPanel();
	companyfirstpanel.setBackground(new Color(44, 47, 51));
	companyfirstpanel.setLayout(new BoxLayout(companyfirstpanel, BoxLayout.Y_AXIS));
	companyfirstpanel.setBorder(new EmptyBorder(0,0,0,0));

	JLabel complabel101 = new JLabel("<html>Company Details</html>");
	complabel101.setFont(new Font("Calibri",Font.BOLD,40));
	complabel101.setForeground(Color.decode("#aaf0d1"));
	//complabel101.setBorder(new EmptyBorder(0,50,0,0));
	complabel101.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	complabel101.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	complabel101.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	complabel101.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	complabel101.setAlignmentX(Component.LEFT_ALIGNMENT);
	complabel101.setOpaque(false);

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    JPanel companysecondpanel = new JPanel();
	companysecondpanel.setBackground(new Color(44,47,51));
	companysecondpanel.setLayout(new BoxLayout(companysecondpanel, BoxLayout.Y_AXIS));
	companysecondpanel.setBorder(new EmptyBorder(0,0,0,0));
	companysecondpanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	JPanel companynametypepanel = new JPanel();
	companynametypepanel.setBackground(new Color(44, 47, 51));
	companynametypepanel.setLayout(new BoxLayout(companynametypepanel, BoxLayout.X_AXIS));
	companynametypepanel.setBorder(new EmptyBorder(0,5,0,0));
	companynametypepanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	JPanel companynamepanel = new JPanel();
	companynamepanel.setBackground(new Color(44, 47, 51));
	companynamepanel.setLayout(new BoxLayout(companynamepanel, BoxLayout.Y_AXIS));
	companynamepanel.setBorder(new EmptyBorder(0,0,0,0));
	companynamepanel.setMinimumSize(new Dimension(550, 70));
	companynamepanel.setPreferredSize(new Dimension(550, 70));
	companynamepanel.setMaximumSize(new Dimension(700, 85));
	
	JLabel companynamelabel = new JLabel("<html>Company Name <font color=#ff4040>*</font> <font color=#838996> <font size = 4>(0/100)</font></font></html>");
	companynamelabel.setFont(new Font("Calibri",Font.BOLD,18));
	companynamelabel.setForeground(Color.decode("#7fffd4"));
	companynamelabel.setBorder(new EmptyBorder(0,10,0,0));
	companynamelabel.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	companynamelabel.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	companynamelabel.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	companynamelabel.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	companynamelabel.setAlignmentY(Component.LEFT_ALIGNMENT);
	companynamelabel.setOpaque(false);
	
	HintTextField companynametxtfield = new HintTextField("Enter your Company name");//border ac-border inactive
	companynametxtfield.gainFont=new Font("Arial", Font.PLAIN, 16);////////////typing font
	companynametxtfield.lostFont=new Font("Arial", Font.PLAIN, 16);////////////////inactive font==setFont	
	companynametxtfield.activebgColor=Color.decode("#004953");
	companynametxtfield.inactivebgColor=Color.decode("#091f23");
	companynametxtfield.activefgColor=Color.WHITE;////////////color on type
	companynametxtfield.inactivefgColor=Color.decode("#009494");/////////////color when text inactive
	companynametxtfield.msgColorN=Color.WHITE;//////////color that firstly shown ==setForeground
	companynametxtfield.magColorM=Color.decode("#dc143c");///////// color if user click and unfill/ignore
	companynametxtfield.setFont(new Font("Arial",Font.PLAIN,16));
	companynametxtfield.setForeground(Color.decode("#FFFFFF"));
	companynametxtfield.setBackground(Color.decode("#091f23"));
	companynametxtfield.setColumns(30);
	companynametxtfield.setBorder(BorderFactory.createCompoundBorder(new CustomeBorder(),new EmptyBorder(new Insets(15,25,15,25))));        
    companynametxtfield.addMouseListener(new FieldMouseListener());
	companynametxtfield.setCaretColor(Color.WHITE);
	companynametxtfield.setAlignmentX(Component.LEFT_ALIGNMENT);
	
		companynametxtfield.addKeyListener(new KeyAdapter()
		{
				public void keyPressed(KeyEvent evt)
{
	if(companynametxtfield.getText().length()==0)
	{
		cona = true;
		comlimit();
		
		
		companynamelabel.setText("<html>Company Name <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(companynametxtfield.getText().length()+1)+"/100)</font></font></html>");
	if(evt.getKeyCode() == KeyEvent.VK_BACK_SPACE)
    {  
       evt.consume();
	   cona=false;
		...
		MouseClickSound ms=new MouseClickSound();
		ms.clickSound("Resources/Audio/Common/type_lock.wav",typelockvolume);
	companynamelabel.setText("<html>Company Name <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(companynametxtfield.getText().length())+"/100)</font></font></html>");
            ...
            public void keyTyped(KeyEvent evt) 
			{
				...
				if (companynametxtfield.getText().length() > 0 && companynametxtfield.getText().length() < 100) // limit textfield
				{
					cona = true;
					comlimit();
					companynamelabel.setText("<html>Company Name <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(companynametxtfield.getText().length()+1)+"/100)</font></font></html>");
				...
				if(companynametxtfield.getText().length() <= 0 || companynametxtfield.getText().length() >100)
				{
					cona = false;
					comlimit();
				}	
				if(companynametxtfield.getText().length() >=100)
				{
					cona= false;
					comlimit();
					evt.consume();
...
if(companynametxtfield.getText().length() == 100)
		...
		if (SUBCOMPANY_NAME!="")
		{
			companynametxtfield.setText(SUBCOMPANY_NAME);
		}
	
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	JPanel companytypepanel = new JPanel();
	companytypepanel.setBackground(new Color(44, 47, 51));
	companytypepanel.setLayout(new BoxLayout(companytypepanel, BoxLayout.Y_AXIS));
	companytypepanel.setBorder(new EmptyBorder(0,0,0,0));
	companytypepanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	
    JPanel typecombopanel = new JPanel();
	typecombopanel.setBackground(new Color(44, 47, 51));
	typecombopanel.setLayout(new BoxLayout(typecombopanel, BoxLayout.X_AXIS));
	typecombopanel.setBorder(new EmptyBorder(0,0,0,0));
	typecombopanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	typecombopanel.setMinimumSize(new Dimension(300, 20));
	typecombopanel.setPreferredSize(new Dimension(300, 20));
	typecombopanel.setMaximumSize(new Dimension(500, 30));

	JLabel companytypelabel = new JLabel("<html>Please Select your company type <font color=#ff4040>*</font></html>");
	companytypelabel.setFont(new Font("Calibri",Font.BOLD,18));
	companytypelabel.setForeground(Color.decode("#7fffd4"));
	companytypelabel.setBorder(new EmptyBorder(0,0,0,0));
	companytypelabel.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	companytypelabel.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	companytypelabel.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	companytypelabel.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	companytypelabel.setAlignmentY(Component.LEFT_ALIGNMENT);
	companytypelabel.setOpaque(false);


CustomComboBox combocomtype=new CustomComboBox(Color.decode("#091f23"),Color.WHITE,Color.decode("#004953"),Color.decode("#20b2aa"));//bg-fg-sbg-sfg

    combocomtype.setButtonH(Color.decode("#091f23"));
    combocomtype.setButtonDS(Color.decode("#20b2aa"));
    combocomtype.setButtonS(Color.BLACK);
    combocomtype.setButtonBG(new Color(44, 47, 51));


    JComboBox combcomtype=combocomtype.customComboBox(combocomtype.companytype());


            combcomtype.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e)
                {
					...
					if(combocomtype.getname()=="    Select Your Company Type")
					{
					coty=false;
					comlimit();
					}
						...
						coty=true;
					comlimit();
					SUBCOMPANY_TYPE = combocomtype.getname();
					}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	JPanel designationworkeramountpanel = new JPanel();
	designationworkeramountpanel.setBackground(new Color(44, 47, 51));
	designationworkeramountpanel.setLayout(new BoxLayout(designationworkeramountpanel, BoxLayout.X_AXIS));
	designationworkeramountpanel.setBorder(new EmptyBorder(0,0,0,0));
	designationworkeramountpanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	JPanel designationpanel = new JPanel();
	designationpanel.setBackground(new Color(44, 47, 51));
	designationpanel.setLayout(new BoxLayout(designationpanel, BoxLayout.Y_AXIS));
	designationpanel.setBorder(new EmptyBorder(0,0,0,0));
	designationpanel.setMinimumSize(new Dimension(300, 70));
	designationpanel.setPreferredSize(new Dimension(300, 70));
	designationpanel.setMaximumSize(new Dimension(550, 85));

	JLabel designationlabel = new JLabel("<html>Designation <font color=#ff4040>*</font> <font color=#838996> <font size = 4>(0/20)</font></font></html>");
	designationlabel.setFont(new Font("Calibri",Font.BOLD,18));
	designationlabel.setForeground(Color.decode("#7fffd4"));
	designationlabel.setBorder(new EmptyBorder(0,10,0,0));
	designationlabel.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	designationlabel.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	designationlabel.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	designationlabel.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	designationlabel.setAlignmentY(Component.LEFT_ALIGNMENT);
	designationlabel.setOpaque(false);
	
	HintTextField designationtxtfield = new HintTextField("Your post in your company");//border ac-border inactive
	designationtxtfield.gainFont=new Font("Arial", Font.PLAIN, 16);////////////typing font
	designationtxtfield.lostFont=new Font("Arial", Font.PLAIN, 16);////////////////inactive font==setFont	
	designationtxtfield.activebgColor=Color.decode("#004953");
	designationtxtfield.inactivebgColor=Color.decode("#091f23");
	designationtxtfield.activefgColor=Color.WHITE;////////////color on type
	designationtxtfield.inactivefgColor=Color.decode("#009494");/////////////color when text inactive
	designationtxtfield.msgColorN=Color.WHITE;//////////color that firstly shown ==setForeground
	designationtxtfield.magColorM=Color.decode("#dc143c");///////// color if user click and unfill/ignore
	designationtxtfield.setFont(new Font("Arial",Font.PLAIN,16));
	designationtxtfield.setForeground(Color.decode("#FFFFFF"));
	designationtxtfield.setBackground(Color.decode("#091f23"));
	designationtxtfield.setColumns(30);
	//designationtxtfield.setEchoChar('*');
	designationtxtfield.setBorder(BorderFactory.createCompoundBorder(new CustomeBorder(),new EmptyBorder(new Insets(15,25,15,25))));        
    designationtxtfield.addMouseListener(new FieldMouseListener());
	designationtxtfield.setCaretColor(Color.WHITE);
	designationtxtfield.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	designationtxtfield.addKeyListener(new KeyAdapter()
		{
			public void keyPressed(KeyEvent evt)
{
	if(designationtxtfield.getText().length()==0)
	{
		desig = true;
		comlimit();
		
		
		designationlabel.setText("<html>Designation <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(designationtxtfield.getText().length()+1)+"/20)</font></font></html>");
	if(evt.getKeyCode() == KeyEvent.VK_BACK_SPACE)
    {  
       evt.consume();
	   desig=false;
		...
		MouseClickSound ms=new MouseClickSound();
		ms.clickSound("Resources/Audio/Common/type_lock.wav",typelockvolume);
	designationlabel.setText("<html>Designation <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(designationtxtfield.getText().length())+"/20)</font></font></html>");
            ...
            public void keyTyped(KeyEvent evt) 
			{
				...
				if (designationtxtfield.getText().length() > 0 && designationtxtfield.getText().length() < 20) // limit textfield
				{
					desig = true;
					comlimit();
				...
				if(designationtxtfield.getText().length() <= 0 || designationtxtfield.getText().length() >20)
				{
					desig = false;
					comlimit();
				}	
				if(designationtxtfield.getText().length() >=20)
				{
					desig = false;
					comlimit();
					evt.consume();
...
if(designationtxtfield.getText().length() == 20)
		...
		if (SUBCOMPANY_DESIGNATION!="")
		{
			designationtxtfield.setText(SUBCOMPANY_DESIGNATION);
		}	
	
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	
	JPanel workeramountpanel = new JPanel();
	workeramountpanel.setBackground(new Color(44, 47, 51));
	workeramountpanel.setLayout(new BoxLayout(workeramountpanel, BoxLayout.Y_AXIS));
	workeramountpanel.setBorder(new EmptyBorder(0,0,0,0));
	workeramountpanel.setMinimumSize(new Dimension(300, 70));
	workeramountpanel.setPreferredSize(new Dimension(300, 70));
	workeramountpanel.setMaximumSize(new Dimension(550, 85));

	JLabel workeramountlabel = new JLabel("<html>Total ammount of worker <font color=#ff4040>*</font> <font color=#838996> <font size = 4>(0/10)</font></font></html>");
	workeramountlabel.setFont(new Font("Calibri",Font.BOLD,18));
	workeramountlabel.setForeground(Color.decode("#7fffd4"));
	workeramountlabel.setBorder(new EmptyBorder(0,10,0,0));
	workeramountlabel.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	workeramountlabel.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	workeramountlabel.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	workeramountlabel.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	workeramountlabel.setAlignmentY(Component.LEFT_ALIGNMENT);
	workeramountlabel.setOpaque(false);
	
	HintTextField workeramounttxtfield = new HintTextField("How many workers are working at present");//border ac-border inactive
	workeramounttxtfield.gainFont=new Font("Arial", Font.PLAIN, 16);////////////typing font
	workeramounttxtfield.lostFont=new Font("Arial", Font.PLAIN, 16);////////////////inactive font==setFont	
	workeramounttxtfield.activebgColor=Color.decode("#004953");
	workeramounttxtfield.inactivebgColor=Color.decode("#091f23");
	workeramounttxtfield.activefgColor=Color.WHITE;////////////color on type
	workeramounttxtfield.inactivefgColor=Color.decode("#009494");/////////////color when text inactive
	workeramounttxtfield.msgColorN=Color.WHITE;//////////color that firstly shown ==setForeground
	workeramounttxtfield.magColorM=Color.decode("#dc143c");///////// color if user click and unfill/ignore
	workeramounttxtfield.setFont(new Font("Arial",Font.PLAIN,16));
	workeramounttxtfield.setForeground(Color.decode("#FFFFFF"));
	workeramounttxtfield.setBackground(Color.decode("#091f23"));
	workeramounttxtfield.setColumns(30);
	//workeramounttxtfield.setEchoChar('*');
	workeramounttxtfield.setBorder(BorderFactory.createCompoundBorder(new CustomeBorder(),new EmptyBorder(new Insets(15,25,15,25))));        
    workeramounttxtfield.addMouseListener(new FieldMouseListener());
	workeramounttxtfield.setCaretColor(Color.WHITE);
	workeramounttxtfield.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	
	workeramounttxtfield.addKeyListener(new KeyAdapter() 
		{
			
	
public void keyPressed(KeyEvent e)
{
	if(workeramounttxtfield.getText().length()==0)
	{
		wamoun = true;
		comlimit();
		
		workeramountlabel.setText("<html>Total ammount of worker <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(workeramounttxtfield.getText().length())+"/10)</font></font></html>");
	   ...
	   wamoun=false;
		...
		workeramountlabel.setText("<html>Total ammount of worker <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(workeramounttxtfield.getText().length())+"/10)</font></font></html>");
            ...
            public void keyTyped(KeyEvent evt) 
			{
				...
				if (workeramounttxtfield.getText().length() > 0 && workeramounttxtfield.getText().length() < 10) // limit textfield
				{
					if((workeramounttxtfield.getText().length() == 0) && (workeramounttxtfield.getText()==null || workeramounttxtfield.getText()=="" || workeramounttxtfield.getText()==" "))
					{
						wamoun = false;
						comlimit();
					}
					...
					workeramountlabel.setText("<html>Total ammount of worker <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(workeramounttxtfield.getText().length()+1)+"/10)</font></font></html>");

					}
					
				}
				if(workeramounttxtfield.getText().length() < 0 || workeramounttxtfield.getText().length() >10)
				{
					wamoun = false;
					comlimit();
				}	
				if(workeramounttxtfield.getText().length() >=10)
				{
					wamoun = false;
					comlimit();
					evt.consume();
...
if(workeramounttxtfield.getText().length() == 10)
				...
				designationlabel.setText("<html>Total ammount of worker <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(workeramounttxtfield.getText().length()-1)+"/10)</font></font></html>");
		...
		if (SUBWORKERS_AMOUNT!="")
		{
			workeramounttxtfield.setText(SUBWORKERS_AMOUNT);
		}
		
///////////////////////////////////////////////////////////////////////////////////////////////////////////

	JPanel companyaddresspanel = new JPanel();
	companyaddresspanel.setBackground(new Color(44, 47, 51));
	companyaddresspanel.setLayout(new BoxLayout(companyaddresspanel, BoxLayout.X_AXIS));
	companyaddresspanel.setBorder(new EmptyBorder(0,0,0,0));
	companyaddresspanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	JPanel addresspanel = new JPanel();
	addresspanel.setBackground(new Color(44, 47, 51));
	addresspanel.setLayout(new BoxLayout(addresspanel, BoxLayout.Y_AXIS));
	addresspanel.setBorder(new EmptyBorder(0,0,0,0));
	addresspanel.setMinimumSize(new Dimension(1000, 80));
	addresspanel.setPreferredSize(new Dimension(1000, 80));
	addresspanel.setMaximumSize(new Dimension(1137, 90));
	
	
	JLabel addresslabel = new JLabel("<html>Company Address <font color=#ff4040>*</font> <font color=#838996> <font size = 4>(0/200)</font></font></html>");
	addresslabel.setFont(new Font("Calibri",Font.BOLD,18));
	addresslabel.setForeground(Color.decode("#7fffd4"));
	addresslabel.setBorder(new EmptyBorder(0,10,0,0));
	addresslabel.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	addresslabel.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	addresslabel.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	addresslabel.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	addresslabel.setAlignmentY(Component.LEFT_ALIGNMENT);
	addresslabel.setOpaque(false);

	HintTextField addresstxtfield = new HintTextField("Please enter your company address");//border ac-border inactive
	addresstxtfield.gainFont=new Font("Arial", Font.PLAIN, 16);////////////typing font
	addresstxtfield.lostFont=new Font("Arial", Font.PLAIN, 16);////////////////inactive font==setFont	
	addresstxtfield.activebgColor=Color.decode("#004953");
	addresstxtfield.inactivebgColor=Color.decode("#091f23");
	addresstxtfield.activefgColor=Color.WHITE;////////////color on type
	addresstxtfield.inactivefgColor=Color.decode("#009494");/////////////color when text inactive
	addresstxtfield.msgColorN=Color.WHITE;//////////color that firstly shown ==setForeground
	addresstxtfield.magColorM=Color.decode("#dc143c");///////// color if user click and unfill/ignore
	addresstxtfield.setFont(new Font("Arial",Font.PLAIN,16));
	addresstxtfield.setForeground(Color.decode("#FFFFFF"));
	addresstxtfield.setBackground(Color.decode("#091f23"));
	addresstxtfield.setColumns(30);
	//addresstxtfield.setEchoChar('*');
	addresstxtfield.setBorder(BorderFactory.createCompoundBorder(new CustomeBorder(),new EmptyBorder(new Insets(15,25,15,25))));        
    addresstxtfield.addMouseListener(new FieldMouseListener());
	addresstxtfield.setCaretColor(Color.WHITE);
	addresstxtfield.setAlignmentX(Component.LEFT_ALIGNMENT);

	addresstxtfield.addKeyListener(new KeyAdapter()
		{
			public void keyPressed(KeyEvent evt)
{
	if(addresstxtfield.getText().length()==0)
	{
		...
		addresslabel.setText("<html>Company Address <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(addresstxtfield.getText().length()+1)+"/200)</font></font></html>");
	if(evt.getKeyCode() == KeyEvent.VK_BACK_SPACE)
    {  
       evt.consume();
	   coadd=false;
		...
		MouseClickSound ms=new MouseClickSound();
		ms.clickSound("Resources/Audio/Common/type_lock.wav",typelockvolume);
	addresslabel.setText("<html>Company Address <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(addresstxtfield.getText().length())+"/200)</font></font></html>");
            ...
            public void keyTyped(KeyEvent evt) 
			{
				...
				if (addresstxtfield.getText().length() > 0 && addresstxtfield.getText().length() < 200) // limit textfield
				{
					coadd = true;
					comlimit();
					addresslabel.setText("<html>Company Address <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(addresstxtfield.getText().length()+1)+"/200)</font></font></html>");
				...
				if(addresstxtfield.getText().length() <= 0 || addresstxtfield.getText().length() >200)
				{
					coadd = false;
					comlimit();
				}	
				if(addresstxtfield.getText().length() >=200)
				{
					coadd = false;
					comlimit();
					evt.consume();
...
if(addresstxtfield.getText().length() == 200)
		...
		if (SUBCOMPANY_ADDRESS!="")
		{
			addresstxtfield.setText(SUBCOMPANY_ADDRESS);
		}
		
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	
	JPanel whybuyerpanel = new JPanel();
	whybuyerpanel.setBackground(new Color(44, 47, 51));
	whybuyerpanel.setLayout(new BoxLayout(whybuyerpanel, BoxLayout.Y_AXIS));
	whybuyerpanel.setBorder(new EmptyBorder(0,15,0,0));
	whybuyerpanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	whybuyerpanel.setMinimumSize(new Dimension(1000, 80));
	whybuyerpanel.setPreferredSize(new Dimension(1000, 80));
	whybuyerpanel.setMaximumSize(new Dimension(1137, 90));
	
	/*JPanel areapanel = new JPanel();
	areapanel.setBackground(new Color(44, 47, 51));
	areapanel.setLayout(new BoxLayout(areapanel, BoxLayout.Y_AXIS));
	areapanel.setBorder(new EmptyBorder(0,0,0,0));
	areapanel.setMinimumSize(new Dimension(800, 70));
	areapanel.setPreferredSize(new Dimension(800, 70));
	areapanel.setMaximumSize(new Dimension(1040, 80));*/

	JLabel whybuyerlabel = new JLabel("<html>Why you need a Buyer account? <font color=#ff4040>*</font> <font color=#838996> <font size = 4>(0/300)</font></font></html>");
	whybuyerlabel.setFont(new Font("Calibri",Font.BOLD,18));
	whybuyerlabel.setForeground(Color.decode("#7fffd4"));
	whybuyerlabel.setBorder(new EmptyBorder(0,0,0,50));
	//whybuyerlabel.setBorder(null);
	whybuyerlabel.setVerticalAlignment(JLabel.TOP);/////y axis for all-TOP,CENTER,BOTTOM
	whybuyerlabel.setHorizontalAlignment(JLabel.LEFT);////x axis for all-LEFT,CENTER,RIGHT
	whybuyerlabel.setHorizontalTextPosition(JLabel.LEFT);////x axis for text-LEFT,CENTER,RIGHT
	whybuyerlabel.setVerticalTextPosition(JLabel.TOP);/////y axis for text-TOP,CENTER,BOTTOM
	whybuyerlabel.setAlignmentY(Component.LEFT_ALIGNMENT);
	whybuyerlabel.setOpaque(false);
	
    HintTextArea whybuyertxtfield = new HintTextArea("Tell us something that why you want to open a buyer account");//border ac-border inactive
	whybuyertxtfield.gainFont=new Font("Arial", Font.PLAIN, 16);////////////typing font
	whybuyertxtfield.lostFont=new Font("Arial", Font.PLAIN, 16);////////////////inactive font==setFont
	whybuyertxtfield.activebgColor=Color.decode("#004953");
	whybuyertxtfield.inactivebgColor=Color.decode("#091f23");
	whybuyertxtfield.activefgColor=Color.WHITE;////////////color on type
	whybuyertxtfield.inactivefgColor=Color.decode("#009494");/////////////color when text inactive
	whybuyertxtfield.msgColorN=Color.WHITE;//////////color that firstly shown ==setForeground
	whybuyertxtfield.magColorM=Color.decode("#dc143c");///////// color if user click and unfill/ignore
	whybuyertxtfield.setFont(new Font("Arial",Font.PLAIN,16));
	whybuyertxtfield.setForeground(Color.decode("#FFFFFF"));
	whybuyertxtfield.setBackground(Color.decode("#091f23"));
	whybuyertxtfield.setColumns(30);
	whybuyertxtfield.setLineWrap(true);
	whybuyertxtfield.setWrapStyleWord(true);
	whybuyertxtfield.setBorder(BorderFactory.createCompoundBorder(new CustomeBorder(),new EmptyBorder(new Insets(15,25,15,25))));        
    whybuyertxtfield.addMouseListener(new FieldMouseListener());
	whybuyertxtfield.setCaretColor(Color.WHITE);


	whybuyertxtfield.addKeyListener(new KeyAdapter()
		{
				public void keyPressed(KeyEvent evt)
{
	if(whybuyertxtfield.getText().length()==0)
	{
		whbuy = true;
		comlimit();
		
		
		whybuyerlabel.setText("<html>Why you need a Buyer account? <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(whybuyertxtfield.getText().length()+1)+"/300)</font></font></html>");
	if(evt.getKeyCode() == KeyEvent.VK_BACK_SPACE)
    {  
       evt.consume();
	   whbuy=false;
		...
		MouseClickSound ms=new MouseClickSound();
		ms.clickSound("Resources/Audio/Common/type_lock.wav",typelockvolume);
	whybuyerlabel.setText("<html>Why you need a Buyer account? <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(whybuyertxtfield.getText().length())+"/300)</font></font></html>");
            ...
            public void keyTyped(KeyEvent evt) 
			{
				...
				if (whybuyertxtfield.getText().length() > 0 && whybuyertxtfield.getText().length() < 300) // limit textfield
				{
					whbuy = true;
					comlimit();
					whybuyerlabel.setText("<html>Why you need a Buyer account? <font color=#ff4040>*</font>"+" <font color=#838996> <font size = 4>("+(whybuyertxtfield.getText().length()+1)+"/300)</font></font></html>");
				...
				if(whybuyertxtfield.getText().length() <= 0 || whybuyertxtfield.getText().length() >300)
				{
					whbuy = false;
					comlimit();
				}	
				if(whybuyertxtfield.getText().length() >= 300)
				{
					whbuy = false;
					comlimit();
					evt.consume();
...
if(whybuyertxtfield.getText().length() == 300)
		...
		if (SUBBUYER_REASON!="")
		{
			whybuyertxtfield.setText(SUBBUYER_REASON);
		}
		
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	
	JScrollPane txtareascrollbar = new JScrollPane(whybuyertxtfield);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
    ...
    JPanel companythirdpanel = new JPanel();///usdthirdpanel
	companythirdpanel.setBackground(new Color(44,47,51));
	companythirdpanel.setLayout(new BoxLayout(companythirdpanel, BoxLayout.X_AXIS));
	companythirdpanel.setBorder(new EmptyBorder(129,0,0,0));
	companythirdpanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	
	JPanel companyremovepanel = new JPanel();///usdremovepanel
	companyremovepanel.setBackground(new Color(44, 47, 51));
	companyremovepanel.setLayout(new BoxLayout(companyremovepanel, BoxLayout.X_AXIS));
	companyremovepanel.setBorder(new EmptyBorder(0,0,0,0));
	companyremovepanel.setAlignmentX(Component.CENTER_ALIGNMENT);
	
	JPanel companynextpanel = new JPanel();///usdnextpanel
	companynextpanel.setBackground(new Color(44, 47, 51));
	companynextpanel.setLayout(new BoxLayout(companynextpanel, BoxLayout.X_AXIS));
	companynextpanel.setBorder(new EmptyBorder(0,40,0,0));
	companynextpanel.setAlignmentX(Component.CENTER_ALIGNMENT);

	Border companysubmitbttnborder = new LineBorder(Color.RED, 1);
	
	RoundedCornerHoverButton companyremoveall = new RoundedCornerHoverButton("   Clear All   ");///usdremoveall
	companyremoveall.setFont(new Font("Comic Sans",Font.PLAIN,18));
	companyremoveall.setBackground(Color.decode("#20b2aa"));
	companyremoveall.setForeground(new Color(125,125,125));
	companyremoveall.setForeground(Color.WHITE);
	companyremoveall.setCursor(handcursor);
	companyremoveall.setBorder(companysubmitbttnborder);
	companyremoveall.setOpaque(false);
	//companyremoveall.setEnabled(false);
    companyremoveall.setContentAreaFilled(false);
    companyremoveall.setBorderPainted(true);
	companyremoveall.setAlignmentX(Component.CENTER_ALIGNMENT);
	companyremoveall.setFocusable(false);
	
	companyremoveall.addMouseListener(new MouseAdapter(){
		...
		companyremoveall.addActionListener(new ActionListener(){
	...
	ccontinue = new RoundedCornerHoverButton("     Continue     ");///usdnext
	ccontinue.setFont(new Font("Comic Sans",Font.PLAIN,18));
	ccontinue.setBackground(Color.decode("#20b2aa"));
	ccontinue.setForeground(new Color(125,125,125));
	ccontinue.setForeground(Color.WHITE);
	ccontinue.setCursor(handcursor);
	ccontinue.setBorder(companysubmitbttnborder);
	ccontinue.setOpaque(false);
	ccontinue.setEnabled(false);
    ccontinue.setContentAreaFilled(false);
    ccontinue.setBorderPainted(true);
	ccontinue.setAlignmentX(Component.CENTER_ALIGNMENT);
	ccontinue.setFocusable(false);
	
	ccontinue.addMouseListener(new MouseAdapter(){
		...
		ccontinue.addActionListener(new ActionListener(){
		...
		SUBCOMPANY_NAME = companynametxtfield.getText();
		SUBCOMPANY_DESIGNATION = designationtxtfield.getText();
		SUBWORKERS_AMOUNT = workeramounttxtfield.getText();
		SUBCOMPANY_ADDRESS = addresstxtfield.getText();
		SUBBUYER_REASON = whybuyertxtfield.getText();
...
companyfirstpanel.add(Box.createRigidArea(new Dimension(0, 20)));
companyfirstpanel.add(Box.createRigidArea(new Dimension(10, 0)));
companyfirstpanel.add(complabel101);
companyfirstpanel.add(Box.createRigidArea(new Dimension(0, 25)));

///////////////////////////////////////////////////////////////////////////////////////////////////////////

companynamepanel.add(Box.createRigidArea(new Dimension(5, 0)));
companynamepanel.add(companynamelabel);
companynamepanel.add(Box.createRigidArea(new Dimension(5, 5)));
companynamepanel.add(companynametxtfield);

typecombopanel.add(Box.createRigidArea(new Dimension(0, 0)));
typecombopanel.add(combcomtype);
companytypepanel.add(Box.createRigidArea(new Dimension(0, 0)));
companytypepanel.add(companytypelabel);
companytypepanel.add(Box.createRigidArea(new Dimension(0, 15)));
companytypepanel.add(typecombopanel);
companytypepanel.add(Box.createRigidArea(new Dimension(0, 20)));

companynametypepanel.add(companynamepanel);
companynametypepanel.add(Box.createRigidArea(new Dimension(60, 0)));
companynametypepanel.add(companytypepanel);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

designationpanel.add(Box.createRigidArea(new Dimension(6, 0)));
designationpanel.add(designationlabel);
designationpanel.add(Box.createRigidArea(new Dimension(6, 5)));
designationpanel.add(designationtxtfield);

workeramountpanel.add(Box.createRigidArea(new Dimension(5, 0)));
workeramountpanel.add(workeramountlabel);
workeramountpanel.add(Box.createRigidArea(new Dimension(5, 5)));
workeramountpanel.add(workeramounttxtfield);

designationworkeramountpanel.add(Box.createRigidArea(new Dimension(0, 0)));
designationworkeramountpanel.add(designationpanel);
designationworkeramountpanel.add(Box.createRigidArea(new Dimension(40, 0)));
designationworkeramountpanel.add(workeramountpanel);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

addresspanel.add(Box.createRigidArea(new Dimension(2, 0)));
addresspanel.add(addresslabel);
addresspanel.add(Box.createRigidArea(new Dimension(2, 5)));
addresspanel.add(addresstxtfield);

companyaddresspanel.add(addresspanel);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

//areapanel.add(txtareascrollbar);
whybuyerpanel.add(Box.createRigidArea(new Dimension(190, 0)));
whybuyerpanel.add(whybuyerlabel);
whybuyerpanel.add(Box.createRigidArea(new Dimension(100, 10)));
whybuyerpanel.add(txtareascrollbar);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

companysecondpanel.add(companynametypepanel);
companysecondpanel.add(Box.createRigidArea(new Dimension(0, 20)));
companysecondpanel.add(designationworkeramountpanel);
companysecondpanel.add(Box.createRigidArea(new Dimension(0, 20)));
companysecondpanel.add(companyaddresspanel);
companysecondpanel.add(Box.createRigidArea(new Dimension(0, 20)));
companysecondpanel.add(whybuyerpanel);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

companyremovepanel.add(companyremoveall);
companynextpanel.add(ccontinue);
companythirdpanel.add(Box.createRigidArea(new Dimension(100, 0)));
companythirdpanel.add(Box.createRigidArea(new Dimension(0, 100)));
companythirdpanel.add(companyremovepanel);
companythirdpanel.add(Box.createRigidArea(new Dimension(700, 0)));
companythirdpanel.add(Box.createRigidArea(new Dimension(0, 100)));
companythirdpanel.add(companynextpanel);


///////////////////////////////////////////////////////////////////////////////////////////////////////////

companypan.add(companyfirstpanel);
companypan.add(Box.createRigidArea(new Dimension(0, 20)));	
companypan.add(companysecondpanel);
companypan.add(Box.createRigidArea(new Dimension(0, 70)));	
companypan.add(companythirdpanel);
...
public JPanel accountdetails(JPanel p)
{
	...
	JLabel newlabel10 = new JLabel("<html> </html>");
...
//////////////////////////////////// last panel ///////////////////////////////////////
	...
	acontinue.addActionListener(new ActionListener(){
        ...
        SUBCOMPANY_TYPE= SUBCOMPANY_TYPE.replace(x1, "");
        SUBCOMPANY_TYPE= SUBCOMPANY_TYPE.replace(x5, "");
...
////////////////////////////////////////
	 ...
	 RAW_POST="Buyer";
//////////////////////////////////////////
	 COMPANY_NAME=SUBCOMPANY_NAME;
	 COMPANY_TYPE=SUBCOMPANY_TYPE;
	 COMPANY_DESIGNATION=SUBCOMPANY_DESIGNATION;
	 WORKERS_AMOUNT=SUBWORKERS_AMOUNT;
	 COMPANY_ADDRESS=SUBCOMPANY_ADDRESS;
	 BUYER_REASON=SUBBUYER_REASON;
///////////////////////////////////////////
...
try{	
     ...
     try{		
		...
		String insertquery1="INSERT INTO `buyer_signup_basic_details` (`USER_NAME`, `EMAIL`, `FULL_NAME`, `FIRST_NAME`, `LAST_NAME`, `COUNTRY_CODE`, `MOBILE_NUMBER`, `GENDER`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+FULL_NAME+"', '"+FIRST_NAME+"', '"+LAST_NAME+"', '"+COUNTRY_CODE+"', '"+MOBILE_NUMBER+"', '"+GENDER+"');";
     ...
     try{		
        ...
        String insertquery2="INSERT INTO `buyer_signup_personal_details` (`USER_NAME`, `EMAIL`, `FULL_NAME`, `DATE_OF_BIRTH`, `BIRTH_DATE`, `BIRTH_MONTH`, `BIRTH_YEAR`, `AGE`, `NID_NUMBER`, `PASSPORT_NUMBER`, `COUNTRY`, `NATIONALITY`, `STREET_ADDRESS`, `ADDRESS_LINE_2`, `CITY`, `STATE`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+FULL_NAME+"', '"+DATE_OF_BIRTH+"', '"+BIRTH_DATE+"', '"+BIRTH_MONTH+"', '"+BIRTH_YEAR+"', '"+AGE+"', '"+NID_NUMBER+"', '"+PASSPORT_NUMBER+"', '"+COUNTRY+"', '"+NATIONALITY+"', '"+STREET_ADDRESS+"', '"+ADDRESS_LINE_2+"', '"+CITY+"', '"+STATE+"');";
     ...
     try{		
        ...
        String insertquery3="INSERT INTO `buyer_signup_user_details` (`USER_NAME`, `EMAIL`, `FULL_NAME`, `PASSWORD`, `PROFILE_PICTURE`, `PROMOTIONAL_EMAIL`, `STATUS`, `STATUS_MESSAGE`, `RAW_POST`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+FULL_NAME+"', '"+PASSWORD+"', '"+PROFILE_PICTURE+"', '"+PROMOTIONAL_EMAIL+"', '"+STATUS+"', '"+STATUS_MESSAGE+"', '"+RAW_POST+"');";
     ...
     try{		
        ...
        String insertquery4="INSERT INTO `buyer_signup_company_details` (`USER_NAME`, `EMAIL`, `FULL_NAME`, `COMPANY_NAME`, `COMPANY_TYPE`, `COMPANY_DESIGNATION`, `WORKERS_AMOUNT`, `COMPANY_ADDRESS`, `BUYER_REASON`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+FULL_NAME+"', '"+COMPANY_NAME+"', '"+COMPANY_TYPE+"', '"+COMPANY_DESIGNATION+"', '"+WORKERS_AMOUNT+"', '"+COMPANY_ADDRESS+"', '"+BUYER_REASON+"');";
	 ...
	 String insertquery5="INSERT INTO `buyer_signup_account_details` (`USER_NAME`, `EMAIL`, `FULL_NAME`, `BANK_ACCOUNT_NUMBER`, `DESCRIPTION`, `HAVE_SELLER`, `SIGN_UP_TIME`, `SIGN_UP_IP`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+FULL_NAME+"', '"+BANK_ACCOUNT_NUMBER+"', '"+DESCRIPTION+"', '"+HAVE_SELLER+"', '"+SIGN_UP_TIME+"', '"+SIGN_UP_IP+"');";	
	 ...
	 String insertquery5="INSERT INTO `buyer_total_rating` (`USER_NAME`, `EMAIL`, `FULL_NAME`, `CURRENT_RATING`, `TOTAL_RATED_BY`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+FULL_NAME+"', '"+TOTAL_RATING+"', '"+TOTAL_RATED_NUMBER+"');";	
...
public JPanel finishpage(JPanel p)
{
	...
	ImageIcon imgx2 = new ImageIcon("Resources/Gifs/Buyer_Signup/success_gif.gif");  //400*300
...
////////////////////////////////////////////////////////////////////////
	...
	public void comlimit()
	{
	
	
		if (BasicDetails== true && PersonalDetails==true && UserDetails==true && cona== true && coty==true && desig== true && wamoun== true && coadd== true && whbuy== true )
		{
	...
	public void acclimit()
	{
		...
		if (BasicDetails== true && PersonalDetails==true && UserDetails==true && CompanyDetails==true && dec== true && atac== true )
		{
