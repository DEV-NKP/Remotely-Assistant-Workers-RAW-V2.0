...
/////////////////////////////cursor///////////////////////////////////
	...
	public buyerlogin()
	{
		...
		public buyerlogin(JFrame frame)
	{
	    screensize = Toolkit.getDefaultToolkit().getScreenSize();
        x = (int) ((screensize.getWidth() - ((screensize.width/2)+320)) / 2);
        y = (int) ((screensize.getHeight() - ((screensize.height/2)+220)) / 2);
...
public JPanel buyerlogpage(JFrame frame)
{
...
screensize = Toolkit.getDefaultToolkit().getScreenSize();
   ...
   borderpan1.setBorder(new LineBorder (new Color(173,255,47), 5));
	...
	JLabel loglabel = new JLabel("BUYER  LOG-IN");
...
try{		
		...
		String searchquery="SELECT * FROM `buyer_signup_user_details` WHERE BINARY EMAIL  ='"+ umailfield.getText()+"' OR BINARY USER_NAME='"+  umailfield.getText()+"' AND BINARY PASSWORD='"+  passfield.getText()+"'";
...
String lip=rp.localhostaddress()+"\n"+rp.publicipaddress();
        ...
        String insertquery="INSERT INTO `buyer_login` (`USER_NAME`, `EMAIL`, `PASSWORD`, `REMEMBER_ME`, `LOGIN_TIME`, `LOGIN_IP`, `RAW_POST`) VALUES ('"+USER_NAME+"', '"+EMAIL+"', '"+PASSWORD+"','"+REMEMBER_ME+"', '"+ltime+"', '"+lip+"', '"+RAW_POST+"');";
	...
	mainframe.getContentPane().removeAll();
			 ...
			 buyerportal bp = new buyerportal(mainframe, EMAIL, PASSWORD);
			
			//mainframe.setJMenuBar(bp.buyerportalpage(mainframe));
			//mainframe.getContentPane().add(lm.loginmenupage(mainframe));
			mainframe.setContentPane(bp.buyerportalpage(mainframe));
	...
	signbutton.addActionListener(new ActionListener(){
		...
		mainframe.setJMenuBar(null);
            ...
            mainframe.setContentPane(bs.buyersignpage(mainframe));
			mainframe.setVisible(true);
...
JLabel msglabel = new JLabel(" ");
	...
	sendbutton.setBackground(new Color(121, 181, 79));
		...
		String searchquery="SELECT * FROM `buyer_signup_user_details` WHERE BINARY EMAIL  ='"+ mailfield.getText()+"' OR BINARY USER_NAME='"+  mailfield.getText()+"'";
...
try{	
     ...
     try{		
		...
		String updatequery="UPDATE `buyer_signup_user_details` SET `PASSWORD`='"+NEW_PASSWORD+"' WHERE BINARY EMAIL  ='"+ RESET_EMAIL+"' ;";
		...
		String insertquery="INSERT INTO `BUYER_PRP_DETAILS` (`USER_NAME`, `EMAIL`, `OLD_PASSWORD`, `NEW_PASSWORD`, `PRP_TIME`, `PRP_IP`, `RAW_POST`) VALUES ('"+RESET_USER_NAME+"', '"+RESET_EMAIL+"', '"+RESET_OLD_PASSWORD+"', '"+NEW_PASSWORD+"', '"+PRP_TIME+"', '"+PRP_IP+"', '"+RESET_RAW_POST+"');";
